...
# import numpy as np
# , floyd_warshall, dijkstra, bellman_ford, johnson
...
serial_graph_list = [[],
                     ...
                     # 6-10
                     [5, 7, 18], [6, 8, 19], [7, 9, 20], [
                         8, 10, 21], [9, 11, 22],
                     # 11-15 @ ~ E
                     [10, 12, 23], [11, 49, 1], [1, 24, 14, 49], [
                         2, 13, 15, 25], [3, 14, 16, 26],
                     # 16-20 R ~ I
                     [4, 15, 17, 27], [5, 16, 18, 28], [6, 17, 19, 29], [
                         7, 18, 20, 30], [8, 19, 21, 31],
                     # 21-25 O ~ S
                     [9, 20, 22, 32], [10, 21, 23, 33], [11, 22, 34, 49], [
                         13, 25, 35, 50], [14, 24, 26, 36],
                     # 26-30 D ~ J
                     [15, 25, 27, 37], [16, 26, 28, 38], [17, 27, 29, 39], [
                         18, 28, 30, 40], [19, 29, 31, 41],
                     # 31-35 J ~ Z
                     [20, 30, 32, 42], [21, 31, 33, 43], [22, 32, 34, 44], [
                         23, 33, 45, 50], [24, 46, 36, 53],
                     # 36-40 X ~ N
                     [25, 35, 37, 47], [26, 36, 38, 48], [27, 37, 39, 55], [
                         28, 38, 40, 56], [29, 39, 41, 57],
                     # 41-45 M ~ ?
                     [30, 40, 42, 58], [31, 41, 43, 59], [32, 42, 44, 60], [
                         33, 43, 45, 61], [34, 44, 62, 53],
                     # 46-50
                     [35, 47, 54], [36, 46, 48], [37, 47, 55], [
                         12, 23, 13, 52], [12, 34, 24, 53],
                     # 51-56
                     [12, 34, 24, 54], [49, 45, 35], [45, 35, 50], [
                         55, 46, 51], [38, 48, 54], [39, 48, 54],
                     # 57-62
